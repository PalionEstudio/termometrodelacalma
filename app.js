...
\outl0\strokewidth0 \strokec2 let energy = Number(localStorage.getItem("energy")) || 0;\
...
document.getElementById("increaseBtn").addEventListener("click", () => \{\
  ...
  if (energy >= 100) \{\
    penalties++;\
    energy = 0; // Reinicio despu\'e9s de explosi\'f3n\
  \}\
  updateUI();\
\});\
\
// Bajada autom\'e1tica cada 2 segundos\
setInterval(() => \{\
  if (energy > 0) \{\
    energy--;\
    updateUI();\
